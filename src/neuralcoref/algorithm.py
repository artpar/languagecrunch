...
print("Package directory: %s" % PACKAGE_DIRECTORY)
#######################
##### UTILITIES #######
...
class Coref:
    ...
    def run_coref_on_mentions(self, mentions):
        ...
        for mention_idx, ant_list in self.data.get_candidate_pairs(mentions, self.max_dist, self.max_dist_match):
            ...
            self.mentions_single_features[mention_idx] = {"spansEmbeddings": mention.spans_embeddings_, "wordsEmbeddings": mention.words_embeddings_,
                                                          "features": feats_}
            ...
            for ant_idx in ant_list:
                ...
                self.mentions_pairs_features[mention_idx][ant_idx] = {"pairFeatures": feats_,
